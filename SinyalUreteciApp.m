classdef SinyalUreteciApp < handle
    %
    % Usage:
    %     app.SinyalUreteciApp
    ...
    properties (Constant)
        AppPathBase = {'/SinyalUreteci'};
        AppClass = 'SinyalUreteciApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            SinyalUreteciApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'app1')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong app1
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'app1').getString, ...
